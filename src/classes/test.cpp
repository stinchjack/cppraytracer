...
/*
    ...
    scene.shapes["sphere2"]->transformation.setShift((Point){-1, 0, 0});
...
/*
   ...
   scene.shapes["sphere1"]->transformation.setScale(3.0, 3, 3);
   scene.shapes["sphere3"]->diffuse = make_shared<PlainTexture>(Colour (1,1,1));
*/
